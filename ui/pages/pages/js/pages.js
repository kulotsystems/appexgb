    ...
    SelectFx.prototype._createSelectEl = function() {
        var self = this,
            ...
            createOptionHTML = function(el) {
                ...
                return '<li ' + optclass + link + ' data-option data-value="' + el.value + '"><span>' + '<i class="' + $(el).attr('data-icon') + '"></i> ' + el.textContent + '</span></li>';
            };
    ...
    SelectFx.prototype._toggleSelect = function() {
        ...
        if (this._isOpen()) {
            if (this.current !== -1) {
                ...
                this.selPlaceholder.innerHTML = $(this.selOpts[this.current].innerHTML).html();
            }
 ...
 (function($) {
    ...
    var Sidebar = function(element, options) {
     ...
     Sidebar.prototype.toggleSidebar = function(toggle) {
         var body    = $('body');
         var banner1 = body.find('#banner1');
         var banner2 = body.find('#banner2');
         var timer;
